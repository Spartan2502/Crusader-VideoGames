    ...
    $(function() {
        $('#contactForm').validate({
            ...
            messages: {
                ...
                subject: {
                    required: "Vamos, que tienes un tema del que hablar, ¿no?",
                    minlength: "el asunto debe constar de al menos 4 caracteres"
                },
                number: {
                    required: "Deberias tener un número, ¿no?",
                    minlength: "su Número debe constar de al menos 10 caracteres"
                },
                email: {
                    required: "sin correo electrónico, como esperas que mandemos mensaje"
                },
                message: {
